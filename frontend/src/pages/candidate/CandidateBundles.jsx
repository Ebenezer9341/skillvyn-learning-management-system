        ...
        <div className="min-h-screen bg-[#f8fafc] p-8">
            ...
            <div className="max-w-7xl mx-auto mb-12">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                    <div>
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent/5 border border-accent/10 text-accent mb-4">
                            <Sparkles size={14} />
                            <span className="text-[10px] font-black uppercase tracking-widest">Limited Edition Bundles</span>
                        </div>
                        <h1 className="text-4xl font-black text-slate-900 tracking-tight">Expand Your <span className="text-primary">Skillset</span></h1>
                    ...
                    <div className="relative group w-full md:w-96">
                        ...
                        <input 
                            ...
                            className="w-full h-14 bg-white border border-slate-100 rounded-2xl pl-14 pr-6 font-bold text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all shadow-sm"
                        />
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredBundles.map((bundle, idx) => (
                    <motion.div
                        ...
                        className="bg-white rounded-2xl border border-slate-100 shadow-xl shadow-slate-200/50 overflow-hidden hover:scale-[1.02] transition-all cursor-pointer group"
                        onClick={() => { setSelectedBundle(bundle); setShowDetailModal(true); }}
                    >
                        <div className="h-48 bg-gradient-to-br from-primary/10 to-accent/5 relative flex items-center justify-center">
                            <Layers size={64} className="text-primary/20 group-hover:scale-110 transition-transform duration-500" />
                            <div className="absolute inset-0 bg-white/20 backdrop-blur-[1px]" />
                            <div className="absolute top-4 right-4 bg-primary text-white text-[10px] font-black px-3 py-1.5 rounded-full uppercase tracking-widest shadow-lg shadow-primary/30">
                        ...
                        <div className="p-8">
                            ...
                            <div className="flex items-center gap-4 mb-8">
                                <div className="flex items-center gap-2 bg-slate-50 px-3 py-1.5 rounded-2xl text-slate-600">
                                    <BookOpen size={16} />
                            ...
                            <div className="flex items-center justify-between pt-6 border-t border-slate-50">
                                ...
                                <button className="bg-primary hover:bg-primary/90 text-white p-3 rounded-2xl transition-all shadow-lg shadow-primary/20 group-hover:px-6 flex items-center gap-2">
                ...
                {showDetailModal && selectedBundle && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
                        ...
                        >
                            ...
                            <div className="p-10 pb-0 bg-gradient-to-r from-primary/5 to-accent/5">
                                <div className="space-y-2 mb-8">
                                    <div className="inline-flex items-center gap-2 text-[10px] font-black text-primary uppercase tracking-widest bg-white/50 px-3 py-1 rounded-full border border-primary/10">
                                    ...
                                    <div className="space-y-3">
                                        {selectedBundle.courses?.map((course, idx) => (
                                            <div key={course._id || idx} className="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                                <div className="w-12 h-12 rounded-2xl bg-white flex items-center justify-center text-primary shadow-sm border border-slate-100 flex-shrink-0">
                                                    <BookOpen size={20} />
                                                </div>
                                    ...
                                    {(() => {
                                        ...
                                        return (
                                            <button 
                                                ...
                                                className="w-full h-16 bg-white text-primary rounded-2xl font-black uppercase tracking-widest mt-8 hover:bg-primary/5 transition-all flex items-center justify-center gap-3 shadow-lg"
                                            >
