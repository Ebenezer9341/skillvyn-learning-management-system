    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between mb-8">
                <button 
                    onClick={() => navigate(-1)}
                    className="flex items-center gap-2 text-slate-500 hover:text-slate-900 font-bold transition-colors group px-4 py-2 hover:bg-slate-100 rounded-xl"
                >
                ...
                <div className="flex items-center gap-3">
                    <span className={`px-4 py-1.5 rounded-2xl text-[10px] font-black uppercase tracking-widest border  ${
                        userData.isActive !== false ? 'bg-emerald-50 text-emerald-600 border-emerald-100' : 'bg-red-50 text-red-600 border-red-100'
                    }`}>
            ...
            <div className="relative mb-24">
                ...
                <div className="absolute -bottom-16 left-8 md:left-14 flex flex-col md:flex-row md:items-end gap-8">
                    <div className="w-32 h-32 md:w-44 md:h-44 rounded-[2.5rem] border-[6px] border-white overflow-hidden shadow-2xl bg-white">
                        <img 
                    ...
                    <div className="mt-4">
                        <div className="flex items-center gap-3">
                            ...
                            {userData.isActive !== false && <CheckCircle2 size={24} className="text-blue-500" />}
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-4 space-y-6">
                                ...
                                <>
                                    <div className="flex items-center justify-between p-4 bg-blue-50 rounded-2xl">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-sm font-bold text-blue-900">Courses Published</span>
                                        </div>
                                        <span className="text-xl font-black text-blue-900">{stats.courseCount || 0}</span>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-amber-50 rounded-2xl">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-sm font-bold text-amber-900">Avg. Rating</span>
                                        </div>
                                        <span className="text-xl font-black text-amber-900">{stats.averageRating || 0}</span>
                                    </div>
                                </>
                            ) : (
                                <>
                                    <div className="flex items-center justify-between p-4 bg-blue-50 rounded-2xl">
                                        <div className="flex items-center gap-3">
                                            <BookOpen size={20} className="text-blue-600" />
                                            <span className="text-sm font-bold text-blue-900">Courses Taken</span>
                                        </div>
                                        <span className="text-xl font-black text-blue-900">{stats.enrolledCount || 0}</span>
                                    </div>
                                    <div className="flex items-center justify-between p-4 bg-emerald-50 rounded-2xl">
                                        <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-purple-50 rounded-2xl">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-sm font-bold text-purple-900">Certificates</span>
                                        </div>
                                        <span className="text-xl font-black text-purple-900">{stats.certificateCount || 0}</span>
                                    </div>
                                </>
                            )}
                        </div>
                    ...
                    <div className="bg-slate-900 p-8 rounded-2xl text-white shadow-2xl space-y-6">
                        ...
                        <AnimatePresence mode="wait">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {(userData.specialty || 'General Instructor').split(',').map((s, i) => (
                                                    <span key={i} className="px-4 py-2 bg-slate-100 text-slate-700 rounded-xl font-bold text-xs border border-slate-200">
                                                        {s.trim()}
                                                    </span>
                                                ))}
                                            </div>
                            ...
                            {activeTab === 'professional' && userData.role === 'mentor' && (
                                <motion.div
                                    ...
                                    className="space-y-6"
                                >
                                    <div className="p-8 bg-emerald-50/50 rounded-[2rem] border border-emerald-100 flex items-start gap-6">
                                        <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center text-emerald-600 shadow-xl shadow-emerald-200">
                                            <Briefcase size={32} />
                                        </div>
                                        <div>
                                    ...
                                    <div className="grid grid-cols-1 gap-4">
                                        {/* Placeholder for future activity logs or course lists */}
